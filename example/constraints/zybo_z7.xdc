...
set_property -dict { PACKAGE_PIN H15  IOSTANDARD LVCMOS33 } [get_ports { mdc     }]; #IO_L19P_T3_35   Sch=je[4]
...
set_property -dict { PACKAGE_PIN Y17  IOSTANDARD LVCMOS33 } [get_ports { mdio_tri_io  }]; #IO_L7N_T1_34    Sch=je[10]
